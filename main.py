...
background = pygame.image.load("images/img_bg_level_1.png").convert()
...
def About():
    # 娱乐图片
    about_fun_img = pygame.image.load("images/about_fun2.png")
    ...
    Author_text = about_font.render("Author: big-indoorsman", True, WHITE)
    Email_text = about_font.render("E-mail: 15503615751@163.com", True, WHITE)
    ...
    while True:
        ...
        screen.blit(about_fun_img, about_fun_rect)
        ...
        screen.blit(about_fun_img, (0, 700))
...
def Menu():
    ...
    menu_font = pygame.font.Font("font/font.TTF", 100)
    title_text = menu_font.render("plane flight", True, RED)
    ...
    begin_game_rect.left, begin_game_rect.top = 264 + 450, 486 - 200
    ...
    help_rect.left, help_rect.top = 264 + 450, 424 + 0
    ...
    about_rect.left, about_rect.top = 264 + 450, 424 + 150
